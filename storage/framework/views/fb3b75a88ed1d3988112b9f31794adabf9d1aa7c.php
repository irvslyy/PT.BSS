...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html"><img src="<?php echo e(asset('frontend/img/logo-dark.png')); ?>" alt="Klorofil Logo" class="img-responsive logo"></a>
            </div>
  ...
  <!--               <div class="navbar-btn navbar-btn-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="" class="img-circle" alt=""> <span></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                            <ul class="dropdown-menu">
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li><a href="tables.html" class=""><i class="fas fa-trash"></i> <span>trash</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <script src="<?php echo e(asset('frontend/vendor/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/scripts/klorofil-common.js')); ?>"></script>
    <script>
...
</html><?php /**PATH /root/Documents/projectlaravel/bss/resources/views/layouts/app.blade.php ENDPATH**/ ?>